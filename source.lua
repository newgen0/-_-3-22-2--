...
local Window = Alc:NewWindow('Hsbwnwj','Ok ','rbxassetid://')
local MenuFunctions = Window:AddMenu('Functions',"Script Auto Fuck",'ticket','tab')

local TabFunctions = MenuFunctions:AddTab('Main','','box-select')

local MainSection = TabFunctions:AddSection('Auto Fik','','','book-open')
...
MainSection:AddButton('www',function(v)
	print(v)
end)
